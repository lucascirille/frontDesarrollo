...
const schema = yup.object({
    ...
    precioBase: yup.number().transform((value) => (isNaN(value) ? undefined : value)).positive("debe ser un valor mayor que 0").max(999999, "El valor no puede exceder 4 dígitos").required("Este campo es obligatorio"),
    precioHora: yup.number().transform((value) => (isNaN(value) ? undefined : value)).positive("debe ser un valor mayor que 0").max(999999, "El valor no puede exceder 4 dígitos").required("Este campo es obligatorio"),
                ...
                {formVisible && (
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="d-flex gap-2">
                            ...
                            <Button variant="primary" className="ms-2" onClick={() => {setFormVisible(false); setSalonAEditar(null); reset();}}>
                                Cancelar
                            </Button>
                        </div>
                    </Form>
